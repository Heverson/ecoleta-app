...
var PointsController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        points = _b.sent();
                        serializedPoints = points.map(function (point) { return (__assign(__assign({}, point), { image_url: "http://192.168.1.8:3333/uploads/" + point.image })); });
    ...
    PointsController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, point, serializedPoints, items;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        serializedPoints = __assign(__assign({}, point), { image_url: "http://192.168.1.8:3333/uploads/" + point.image });
                    ...
                    case 2:
                        items = _a.sent();
                        return [2 /*return*/, response.json({ point: serializedPoints, items: items })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, trx('points').insert({
                    ...
                    case 2:
                        ...
                        pointItems = items.split(',')
                            .map(function (item) { return Number(item.trim()); })
                            .map(function (item_id) { return ({
                            item_id: item_id,
                            point_id: point_id
                        }); });
